...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        wget -N -O /usr/local/x-ui-linux-$(arch).tar.gz https://ghfast.top/https://github.com/MHSanaei/3x-ui/releases/download/${tag_version}/x-ui-linux-$(arch).tar.gz
        if [[ $? -ne 0 ]]; then
    ...
    wget -O /usr/bin/x-ui https://ghfast.top/https://raw.githubusercontent.com/GH6324/3xui-cn/main/x-ui.sh
